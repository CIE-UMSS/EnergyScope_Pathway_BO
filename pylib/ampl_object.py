...
class AmplObject:
    ...
    def get_total_cost(self):
        ...
        c_inv_phase['Phases'] = pd.Categorical(c_inv_phase['Phases'],['2015_2021'] + self.sets['PHASE_UP_TO'])
        ...
        phases = sorted(set(['2015_2021'] + self.sets['PHASE_UP_TO'] + self.sets['PHASE_WND']))
    ...
    def get_new_old_decom(self):
        ...
        # set Years and Technologies as categorical data and sort it
        assets['Phases'] = pd.Categorical(assets['Phases'], ['2015_2021']+self.sets['PHASE_UP_TO'])
